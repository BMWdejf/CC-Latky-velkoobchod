...
import { getAdminTickets } from "@/lib/queries/tickets";
...
export default async function AdminSupportPage() {
  ...
  const allTickets = await getAdminTickets(session.user.id);
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/50">
                ...
                <th className="px-4 py-3 text-left font-medium text-muted-foreground">Priorita</th>
